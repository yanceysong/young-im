...
import com.yanceysong.im.infrastructure.config.GlobalHttpClientConfig;
...
public class HttpRequestUtils {
    ...
    public String doGet(String url, Map<String, Object> params, Map<String, Object> header, String charset) throws Exception {
        charset = StringUtils.isEmpty(charset) ? String.valueOf(StandardCharsets.UTF_8) : charset;
